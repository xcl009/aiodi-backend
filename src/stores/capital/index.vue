  ...
  <div>
    <div class="p-20 bg-white">
      ...
      <div class="mt-10 mb-10 cursor">
        <span class="text-primary khcoin">￥{{ balance }}</span>
      </div>
      <div>
        <el-button type="primary" size="small" class="fs-s3" @click="$router.push({path: `/capital/withdraw`})">去提现</el-button>
      </div>
    </div>

    <div class="pt-10 pl-10 pr-10 bg-white">
      <div class="mt-10 pb-10 pl-10 fs-c1 text-black">收支概况</div>
      <!-- <condition ref="condition" :clickSubmit="clickSubmit" :exportStatus="true" @reset="reset" @query="toQuery" @saveXlsx="outTab('list_table', '收益明细')">
