<template>
  <div>
    <div class="mb-10" v-if="isEdit">
      <el-input v-model="keyword" placeholder="请输入地址搜索" />
    ...
    <baidu-map ref="map_box" class="bm-view" :style="{height: height}" :ak="config.baidu_map_ak" :center="center.lat ? center : iniCenter" :zoom="zoom" :scroll-wheel-zoom="true" @ready="handler" @click="mapClick" @moveend="handlerMoveend">
      ...
      <bm-local-search class="search-list" :auto-viewport="true" :keyword="keyword" :page-capacity="5" :panel="showPanel" @infohtmlset="infohtmlset"></bm-local-search>
