 ...
 -->
  <div id="meQrcode" :title="qrText">
    <div class="qrcode_box">
      ...
      <canvas :width="qrSize" :height="qrSize + 25" class="canvas bg-white" ref="canvas"></canvas>
    </div>
  </div>
</template>
<script>
...
export default {
  props: {
    ...
    qrLogo: {
      type: String,
      default: 'https://oss.kuaihuoya.net/pwd/2020-09-10/154484479.jpg'
    },
    qrLogoSize: {
      type: Number,
      default: 40
        ...
        (err, url) => {
          ...
          setTimeout(() => {
            ...
            if (that.qrText) {
              ...
              ctx.fillStyle = "#333"
              ctx.fillText(that.qrText, fleft, ftop + 15)
            }
            if (that.qrLogo) {
              //设置logo大小
