        ...
        <el-col :xs="12" :sm="12" :md="8" :lg="6" v-for="(item, index) in list" class="mb-20 cursor">
          <div class="role-item flexv justify-between">
            <div class="flex align-center">
              ...
              <div class="flex-sub pl-20">
                <div class="flex align-center">
                  ...
                  <div class="text-primary" @click="$router.push({path: `/role/addRole?roleId=${item.roleId}`})">编辑</div>
                </div>
            ...
            <div class="text-right">
              ...
              <el-button type="primary" size="small" @click="$router.push({path: `/role/roleAccount?roleId=${item.roleId}`})">查看账号</el-button>
            </div>
          </div>
        </el-col>
      </el-row>
