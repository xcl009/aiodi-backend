  ...
  <div>
    <condition ref="condition" :clickSubmit="clickSubmit" @reset="reset" @query="toQuery">
      ...
      <template v-slot:endButton>
        <el-button type="primary" size="small" class="mr-10" @click="setRows(3, {}, 1)"><i
            class="el-icon-plus el-icon--left" />添加字典</el-button>
      </template>
    </condition>
    ...
    <div class="pl-10 pr-10 bg-white">
      <div class="flex align-center pt-15 mb-15 l-t">
        ...
        <table-column-set storageKey="globalTableColumn" :showColumn.sync="showColumn" :defaultColumn="defaultColumn"></table-column-set>
      </div>
        ...
        <el-table-column label="操作" width="110">
          <template slot-scope="scope">
            <div class="flex flex-wrap operate">
              <el-button type="text" @click="setRows(3, scope.row, 2)">编辑</el-button>
              <el-popconfirm
                class="pop"
                cancel-button-type=""
                icon="el-icon-info"
        ...
        <el-form class="custom-form pl-20 pr-20" @submit.native.prevent="dialogConfirm()">
          <el-form-item label="所属类型">
            <el-select v-model="dform.type">
              <el-option :label="`${item.value}`" :value="item.code" :key="index" v-for="(item, index) in types"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="语言类型">
            <el-select v-model="dform.lan">
              <el-option :label="`${item.value}`" :value="item.code" :key="index" v-for="(item, index) in dists"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="语言模块">
          ...
          <el-form-item label="语言标签">
            <el-input v-model="dform.lab" placeholder="语言标签"></el-input>
          </el-form-item>
          <el-form-item label="语言编码">
            <el-input v-model="dform.code" placeholder="语言编码"></el-input>
          </el-form-item>
          <el-form-item label="语言标识">
            <el-input v-model="dform.keyes" placeholder="语言标识"></el-input>
          </el-form-item>
          <el-form-item label="语言内容">
            <el-input v-model="dform.val" placeholder="内容" style="width: 600px;"></el-input>
          </el-form-item>
          <el-form-item label="备注信息">
            <el-input v-model="dform.remark" placeholder="备注信息" type="textarea" :rows="4" />
          </el-form-item>
        </el-form>
      </template>
