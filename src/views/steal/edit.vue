          ...
          <h4 class="flex mb-20 mt-10">
            ...
            <div class="ml-5">
              <el-popover
                ...
                trigger="hover">
                <div>
                  设置了时间段表示该时间段完结的订单会执行漏单，漏掉的订单将会隐藏且不给下级及商户分成。<br>
                </div>
                <svg-icon icon-class="doubt" slot="reference"></svg-icon>
              </el-popover>
            </div>
            ...
            <div class="ml-5">
              <el-popover
                ...
                <div>
                  ...
                  订单金额大于0且未被DD的订单才会执行漏单，漏掉的订单将会隐藏且不给下级及商户分成<br>
                </div>
                <svg-icon icon-class="doubt" slot="reference"></svg-icon>
              </el-popover>
            </div>
            ...
            <div class="ml-5">
              <el-popover
                ...
                <div>
                  ...
                  例：分成时间60分钟，真实使用时长120分钟，订单计费为2元60分钟，该订单真实扣款4元。下级及商户按2元分成，剩余2元则按比例分给您及您的上级。
                </div>
                <svg-icon icon-class="doubt" slot="reference"></svg-icon>
              </el-popover>
            </div>
            ...
            <div class="ml-5">
              <el-popover
                ...
                <div>
                  ...
                  例：扣减时间10分钟，真实使用时长65分钟，订单计费为2元60分钟，该订单真实扣款4元。扣减10分钟后使用时长55分钟，订单金额2元，下级及商户按2元分成，剩余2元则按比例分给您及您的上级。
                </div>
                <svg-icon icon-class="doubt" slot="reference"></svg-icon>
              </el-popover>
            </div>
          ...
          <h4 class="flex mb-20 mt-10">
            ...
            <div class="ml-5">
              <el-popover
                ...
                <div>
                  起漏金额：订单金额须大于等于起漏金额。<br>
                  订单金额大于0且未被DD的订单才会执行漏单，漏掉的订单将会展示为扣款失败且不给下级及商户分成。<br>
                </div>
                <svg-icon icon-class="doubt" slot="reference"></svg-icon>
              </el-popover>
            </div>
