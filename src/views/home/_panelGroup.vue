<template>
  <el-row :gutter="device === 'mobile' ? 10 : 20" class="pl-20 pt-20 pr-20 panel-group bg-white">
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col" v-if="agentInfo.business_type != 1">
      <div class="radius-10 o-v card-panel cursor text-white" @click="$router.push({path: `/money/dayMoney`})">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="radius-10 o-v card-panel cursor text-white" @click="$router.push({path: '/order'})">
        <div class="p-15 flex align-end">
          <div class="flex1 flex line-1 align-start fs-s3">
            <span class="mt-10">日</span>
            <i class="iconfont icon-xiajiang"></i>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="radius-10 o-v card-panel cursor text-white" @click="$router.push({path: `/device`})">
        <div class="p-15 flex align-end">
          <div class="flex1 flex line-1 align-start fs-s3">
            <span class="mt-10">日</span>
            <i class="iconfont icon-xiajiang"></i>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="radius-10 o-v card-panel cursor text-white" @click="$router.push({path: `/userManage`})">
        <div class="p-15 flex align-end">
          <div class="flex1 flex line-1 align-start fs-s3">
            <span class="mt-10">日</span>
            <i class="iconfont icon-xiajiang"></i>
