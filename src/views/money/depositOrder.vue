      ...
      <el-col :span="24" :md="8" class="item-box">
        <div class="flex align-center pl-30 pr-30 pt-20 pb-20 info radius-5">
          ...
          <div class="flex1 ml-30">
            ...
            <div><span class="mr-5 fs-b3 text-bold">{{ totalStat.allNumber || 0 }}</span>笔</div>
          </div>
        </div>
      </el-col>
      <el-col :span="24" :md="8" class="item-box">
        <div class="flex align-center pl-30 pr-30 pt-20 pb-20 info radius-5">
          ...
          <div class="flex1 ml-30">
            <div class="mb-5">未退金额</div>
            <div><span class="mr-5 fs-b3 text-bold">{{ totalStat.unrefundAmount || 0.00 }}</span>元</div>
          </div>
          <div class="flex1 ml-30">
            <div class="mb-5">未退笔数</div>
            <div><span class="mr-5 fs-b3 text-bold">{{ totalStat.unrefundNumber || 0 }}</span>笔</div>
          </div>
        </div>
      </el-col>
      <el-col :span="24" :md="8" class="item-box">
        <div class="flex align-center pl-30 pr-30 pt-20 pb-20 info radius-5">
          ...
          <div class="flex1 ml-30">
            <div class="mb-5">已退金额</div>
            <div><span class="mr-5 fs-b3 text-bold">{{ totalStat.refundedAmount || 0 }}</span>元</div>
          </div>
          <div class="flex1 ml-30">
            <div class="mb-5">已退笔数</div>
            <div><span class="mr-5 fs-b3 text-bold">{{ totalStat.refundedNumber || 0 }}</span>笔</div>
          </div>
        </div>
      </el-col>
    </el-row>
